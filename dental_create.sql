...
ALTER TABLE Appointment ADD CONSTRAINT Appointment_Transactions FOREIGN KEY Appointment_Transactions (Transaction_id)
...
ALTER TABLE Bills ADD CONSTRAINT Bills_Transactions FOREIGN KEY Bills_Transactions (Transaction_id)
    REFERENCES Transactions (Transaction_id);

-- Reference: Transactions_Treatement (table: Transactions)
ALTER TABLE Transactions ADD CONSTRAINT Transactions_Treatement FOREIGN KEY Transactions_Treatement (treatement_id)
    REFERENCES Treatment (treatement_id);
