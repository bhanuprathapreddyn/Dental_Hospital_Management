...
insert into Treatment values('TT1001','molar removal');
insert into Treatment values('TT1002','Normal Checkup');
insert into Treatment values('TT1003','teeth setting');
insert into Treatment values('TT1004','Cavity fillings');
insert into Treatment values('TT1005','Gum Disease Treatment');

insert into Transactions values('TS0023', 'TT1001');
insert into Transactions values('TS0024', 'TT1002');
insert into Transactions values('TS0025', 'TT1004');
insert into Transactions values('TS0109', 'TT1005');
